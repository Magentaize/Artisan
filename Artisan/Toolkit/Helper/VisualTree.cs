    ...
    public static class VisualTree
    {
        ...
        public static FrameworkElement FindVisualElementFormName(FrameworkElement container, String name)
        {
            ...
            while (childQueue.Count > 0)
            {
                ...
                {
                    childQueue.Enqueue(
                        VisualTreeHelper.GetChild(current, childIndex) as FrameworkElement);
                }
            }
        ...
        /// <returns>找到的控件</returns>
        public static T FindParentVisualElement<T>(DependencyObject container) where T : FrameworkElement
        {
        ...
        {
            return VisualTreeHelper.GetOpenPopups(window);
        }
    }
}